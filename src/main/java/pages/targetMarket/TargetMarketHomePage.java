...
public class TargetMarketHomePage extends BasePage {
	...
	public void clickOnTopsTab() {clickOnTab("Tops");}
	public void clickOnWomenDressesTab() {clickOnTab("Womens Dresses");}
	public void clickOnWomenShoesTab() {clickOnTab("Womens Shoes");}
