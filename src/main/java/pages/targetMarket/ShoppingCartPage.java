...
//            getItemOnCart(itemName).findElement(By.xpath("//button[text()='+']")).click();
    ...
    public int getTotalPrice(){
        String price = totalPrice.getText().substring(15);
    ...
    public String getItemPrice(String itemName){
        String price = getItemOnCart(itemName).findElement(By.cssSelector("div > div > p[class='text-muted mb-0 fs-4']:nth-child(2)")).getText();
    ...
    public String getItemTotalPriceOnCart(String itemName){
         String totalPrice = getItemOnCart(itemName).findElement(By.cssSelector("div > div > p[class='text-muted mb-0 fs-4']:nth-child(3)")).getText();
