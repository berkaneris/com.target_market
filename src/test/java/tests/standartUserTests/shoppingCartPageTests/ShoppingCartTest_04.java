...
public class ShoppingCartTest_04 extends Hooks {
	...
	public Object[][] provideLoginCredentials() {
		return new Object[][] { { "All", "perfume Oil", "cereals muesli fruit nuts", "$13", "$46" },
	...
	public void testShoppingCartWithDifferentProducts(String tabName, String itemName1, String itemName2,
			String priceItem1, String priceItem2) {
