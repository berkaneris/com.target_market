...
public class CheckOutTest_03 extends Hooks {
    ...
    public Object[][] provideLoginCredentials() {
        return new Object[][] {
                {"John", "King", "NewYork" , "4123678945673214" , "5334445556"},
    ...
    public void testCheckOutWithDifferentUsers(String firstName, String lastName, String address , String cardNumber , String phoneNumber) {
